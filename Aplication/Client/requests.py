...
##@brief: classe responsavel por agrupar as constatantes relacionadas a requests e responses
...
##@brief: classe responsavel por reunir as informações de uma compra alem de dispor de metodos para tradução em dicionario ou tradução de um dicionario
class Ticket:
    ...
    ##@brief: metodo responsavel por converter os dados de um dicionario em um TIcket
    # @param: values - dict, dicionario a ser convertida em Ticket
    ...
    ##@brief: metodo responsavel por converter os dados de um Ticket em um dicionario 
    # @return: dict, um dicionario com as chaves sendo os campos e os valores os dados do Ticekt
    def to_json(self):
